...
export default function Footer() {
  return (
    <footer className="w-full  shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
      <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2023{" "}
        <a href="https://kevinriveros.com" className="hover:underline" target="_blank">
          kevinriveros.com
        </a>
      </p>
